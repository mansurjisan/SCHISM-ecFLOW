...
#export cycle="06"
#export PDYHH_NCAST_BEGIN="20250125"
##
# Clean and create working directory

echo "DATA_prep_nwm: $DATA_prep_nwm"
echo "FIXstofs3d: $FIXstofs3d"
echo "COMINnwm: $COMINnwm"
echo "PYstofs3d: $PYstofs3d"
...
# Construct start_date from ecFlow-provided variables
#start_date="${PDYHH_NCAST_BEGIN:0:4}-${PDYHH_NCAST_BEGIN:4:2}-${PDYHH_NCAST_BEGIN:6:2}-${cycle}"
#start_date="${PDYHH_NCAST_BEGIN:0:4}-${PDYHH_NCAST_BEGIN:4:2}-${PDYHH_NCAST_BEGIN:6:2} ${cycle}:00:00"
year="${PDYHH_NCAST_BEGIN:0:4}"
month="${PDYHH_NCAST_BEGIN:4:2}"
day="${PDYHH_NCAST_BEGIN:6:2}"
hour="${PDYHH_NCAST_BEGIN:8:2}"
start_date="${year}-${month}-${day}-${hour}"
