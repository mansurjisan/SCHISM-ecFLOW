...
#  module load wgrib2
#  export WGRIB2="/apps/spack-managed/oneapi-2022.2.1/wgrib2-3.1.1-3rtpvbkvwvwgo7psf4bziwry5qeiokyt/bin/wgrib2"
#  export ncap2="/apps/spack-managed/oneapi-2022.2.1/nco-5.1.6-lrv2maxinji3qugcj36qnhrpjgdp7cf2/bin/ncap2"
...
k=0
   ...
   if [[ ${dim_k} -ge ${N_dim_cr_max} ]]; then
      ...
      cp -pf ${fn_std} ${COMOUTrerun}/${fn_std_1}
      cp -pf ${fn_std} ${COMOUTrerun}/${fn_std_2}
      cp -pf ${fn_std} ${COMOUTrerun}/${fn_std_3}
      ...
      if [[ -f  ${COMOUT_PREV}/rerun/${fn_std} ]]; then 
        ...
        cp -pf ${COMOUT_PREV}/rerun/${fn_std} ${fn_prev}
