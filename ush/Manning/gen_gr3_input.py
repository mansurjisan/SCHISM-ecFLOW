...
if __name__ == '__main__':
    hgrid = Gr3.open('/home/mjisan/workflow/schism_suite/fix/hgrid.gr3', crs='epsg:4326')
    grd = hgrid.copy()
    gr3_names = ['albedo', 'diffmax', 'diffmin', 'watertype', 'windrot_geo2proj','rough','elev']
    values = [2.000000e-1, 1.0000000e-02, 1.0000000e-06, 4, 0.00000000, 1.0000000e-04, 6.3870000e-01]
    for name, value in zip(gr3_names, values):
        write_gr3_file(f'../../workdir/{name}.gr3', grd, value, name)
