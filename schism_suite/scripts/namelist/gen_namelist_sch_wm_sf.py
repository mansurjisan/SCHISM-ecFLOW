...
def generate_param_nml(start_year, start_month, start_day, start_hour):
...
! Baroclinic/barotropic option. If ibc=0 (baroclinic model), ibtp is not used.
  ...
  rnday = 0.16667 !total run time in days
...
def main():
    ...
    content = generate_param_nml(args.year, args.month, args.day, args.hour)

    with open("../../workdir/param.nml", "w") as f:
        f.write(content)
